...
transaction(name: String, description: String, mediaType: String, mediaHash: String, mediaURI: String){
    prepare(signer: AuthAccount) {
        ...
        let collectibleMetadata = Collectibles.Metadata(name: name, description: description,
