...
pub contract Collectibles: NonFungibleToken {
    ...
    init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/goatedgoatsLaunchCollectiblesCollection
        self.CollectionPublicPath = /public/goatedgoatsLaunchCollectiblesCollection
        self.MinterStoragePath = /storage/goatedgoatsLaunchCollectiblesMinter
