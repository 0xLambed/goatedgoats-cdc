...
pub contract Vouchers: NonFungibleToken {
    ...
    //
    init() {
        self.CollectionStoragePath = /storage/goatedgoatsLaunchVouchersCollection
        self.CollectionPublicPath = /public/goatedgoatsLaunchVouchersCollection
		
        // only one redeemedCollection should ever exist, in the deployer storage
        self.RedeemedCollectionStoragePath = /storage/goatedgoatsLaunchVouchersRedeemedCollection
        self.RedeemedCollectionPublicPath = /public/goatedgoatsLaunchVouchersRedeemedCollection
        
        // only one Administrator should ever exist, in deployer storage
        self.AdministratorStoragePath = /storage/goatedgoatsLaunchVouchersAdministrator
        self.AdministratorPrivatePath = /private/goatedgoatsLaunchVouchersAdministrator

        self.AdminProxyPublicPath = /public/goatedgoatsLaunchVouchersAdminProxy
        self.AdminProxyStoragePath = /storage/goatedgoatsLaunchVouchersAdminProxy
